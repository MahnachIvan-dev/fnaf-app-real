...
function updateUI(st) {
    ...
    if (killBtn) {
        ...
        else if (st.killPowerUsesLeft <= 0) { killBtn.disabled = true; killBtn.textContent = 'NO CHARGES LEFT'; }
        else { killBtn.disabled = false; killBtn.textContent = `⚡ KILL POWER (${st.killPowerUsesLeft} LEFT)`; }
    }
