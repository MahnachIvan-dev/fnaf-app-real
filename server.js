...
io.on('connection', (socket) => {
    ...
    socket.on('startGame', (gameId) => {
        ...
        game.power = MAX_POWER; game.powerAtOut = MAX_POWER; game.systemOff = false; game.isDeadPower = false; game.camerasUp = false;
        game.overloadLevel = 0; game.overloadTripped = false;
